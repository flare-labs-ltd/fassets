...
import {
    ...
    IWhitelistInstance, StateConnectorMockInstance, WNatInstance, CollateralPoolTokenFactoryInstance, IPriceReaderInstance, IAgentOwnerRegistryInstance, AgentOwnerRegistryInstance
