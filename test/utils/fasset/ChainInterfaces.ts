...
export interface IBlockChain {
    ...
    getTransactionBlock(txHash: string): Promise<string | null>;
...
export interface IChainWallet {
    ...
    addTransaction(sourceAddress: string, targetAddress: string, amount: BNish, reference: string | null, options?: TransactionOptionsWithFee): Promise<string>;
    ...
    // Returns new transaction hash.
    addMultiTransaction(spend: { [address: string]: BNish }, receive: { [address: string]: BNish }, reference: string | null, options?: TransactionOptions): Promise<string>;
}
