...
import { getTestFile, HOURS, MINUTES, toBN, toBNExp, toStringExp } from "../../utils/helpers";
...
contract(`AssetManagerController.sol; ${getTestFile(__filename)}; Asset manager controller basic tests`, async accounts => {
    ...
    describe("set and update settings with controller", () => {
        ...
        it("should revert updating whitelist without governance", async () => {
        ...
        it("should update time for payment", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating max trusted price age seconds when increase or decrease is too big", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should update max trusted price age seconds", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating collateral reservation fee bips when increase or decrease is too big", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should update collateral reservation fee bips", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating redemption fee bips when increase or decrease is too big", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating confirmation by others after seconds when value too low", async () => {
        ...
        it("should update confirmation by others after seconds", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating confirmation by others reward NATWei when increase or decrease is too big", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should update confirmation by others reward NATWei", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating max redeemed tickets when increase or decrease is too big or value is < 1", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should update max redeemed tickets", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating withdrawal wait when increase is too big or value is < 1", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should update withdrawal wait", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating ccb time when increase or decrease is too big", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should update ccb time", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should revert updating liquidation step when increase or decrease is too big", async () => {
            const currentSettings = await assetManager.getSettings();
        ...
        it("should update liquidation step", async () => {
            const currentSettings = await assetManager.getSettings();
