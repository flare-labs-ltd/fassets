...
library PaymentReference {
    ...
    uint256 internal constant TRANSFER_FROM_CORE_VAULT = 0x4642505266410004 << TYPE_SHIFT;
    ...
    function transferFromCoreVault(uint64 _id) internal pure returns (bytes32) {
        return bytes32(uint256(_id) | TRANSFER_FROM_CORE_VAULT);
    }
