...
library PaymentReference {
    ...
    uint256 internal constant CORE_VAULT_REDEMPTION = 0x4642505266410004 << TYPE_SHIFT;
    ...
    function coreVaultRedemption(uint64 _id) internal pure returns (bytes32) {
        return bytes32(uint256(_id) | CORE_VAULT_REDEMPTION);
    }
