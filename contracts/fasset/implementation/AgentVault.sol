...
contract AgentVault is ReentrancyGuard, IAgentVault {
    ...
    function claimFtsoRewards(
        ...
        returns (uint256)
    {
        return _ftsoRewardManager.claimReward(_recipient, _rewardEpochs);
    }
    ...
    function claimAirdropDistribution(
        ...
        returns(uint256)
    {
        return _distribution.claim(_recipient, _month);
    }
    ...
    function destroy(IWNat _wNat, address payable _recipient) external override onlyAssetManager {
